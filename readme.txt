...
(at the time of writing user registration and login work fine, as well as adding the books based on ISBN and displaying the books to the user, the rest of functionalities need to be tested)
